...
- `MonitorForm` — 52px borderless circular topmost window. Left-drag moves it, left-click toggles mute, right-click menu (Re-authorize / Exit). GDI+ paints the mic icon; green = unmuted, red + slash = muted/deafened, gray = disconnected.
